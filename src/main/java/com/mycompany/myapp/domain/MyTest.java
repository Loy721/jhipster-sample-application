...
public class MyTest implements Serializable {
    ...
    public void setMyQuestions(Set<Question> questions) {
        if (this.myQuestions != null) {
            this.myQuestions.forEach(i -> i.setMyTest(null));
        }
        if (questions != null) {
    ...
    public MyTest myQuestions(Set<Question> questions) {
        this.setMyQuestions(questions);
        return this;
    }

    public MyTest addMyQuestions(Question question) {
        this.myQuestions.add(question);
        question.setMyTest(this);
        return this;
    }

    public MyTest removeMyQuestions(Question question) {
        this.myQuestions.remove(question);
