...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './my-file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYFILE actions', async () => {
      const expectedActions = [
        {
