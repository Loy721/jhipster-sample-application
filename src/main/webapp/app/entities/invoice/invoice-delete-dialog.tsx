...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.invoice.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
