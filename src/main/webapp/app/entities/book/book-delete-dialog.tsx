...
export const BookDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.book.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.book.delete.question" interpolate={{ id: bookEntity.id }}>
