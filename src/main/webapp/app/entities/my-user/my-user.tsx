  ...
  return (
    <div>
      <h2 id="my-user-heading" data-cy="MyUserHeading">
        <Translate contentKey="jhipsterSampleApplicationApp.myUser.home.title">My Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationApp.myUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/my-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.myUser.home.createLabel">Create new My User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {myUserList && myUserList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.myUser.id">ID</Translate>{' '}
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/my-user/${myUser.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.myUser.home.notFound">No My Users found</Translate>
            </div>
          )
        )}
      </div>
