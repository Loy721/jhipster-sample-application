...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './my-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYUSER actions', async () => {
      const expectedActions = [
        {
