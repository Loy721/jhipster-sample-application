...
export const MyUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.myUser.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.myUser.delete.question" interpolate={{ id: myUserEntity.id }}>
