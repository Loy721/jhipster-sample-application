...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './my-test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYTEST actions', async () => {
      const expectedActions = [
        {
