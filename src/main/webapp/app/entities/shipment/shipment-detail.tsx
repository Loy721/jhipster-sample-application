    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shipmentDetailsHeading">
          <Translate contentKey="jhipsterSampleApplicationApp.shipment.detail.title">Shipment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplicationApp.shipment.invoice">Invoice</Translate>
          </dt>
