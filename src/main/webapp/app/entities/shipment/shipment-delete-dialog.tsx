...
export const ShipmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.shipment.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.shipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
