  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.shipment.home.createOrEditLabel" data-cy="ShipmentCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.shipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.shipment.trackingCode')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.shipment.date')}
                id="shipment-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.shipment.details')}
                id="shipment-details"
                name="details"
                data-cy="details"
                type="text"
              ...
              <ValidatedField
                ...
                name="invoice"
                data-cy="invoice"
                label={translate('jhipsterSampleApplicationApp.shipment.invoice')}
                type="select"
                required
              >
                <option value="" key="0" />
