...
export const AuthorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.author.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.author.delete.question" interpolate={{ id: authorEntity.id }}>
