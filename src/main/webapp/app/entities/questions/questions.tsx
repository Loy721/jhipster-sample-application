  ...
  return (
    <div>
      <h2 id="questions-heading" data-cy="QuestionsHeading">
        <Translate contentKey="jhipsterSampleApplicationApp.questions.home.title">Questions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationApp.questions.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/questions/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.questions.home.createLabel">Create new Questions</Translate>
          </Link>
        </div>
      </h2>
        ...
        {questionsList && questionsList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.questions.home.notFound">No Questions found</Translate>
            </div>
          )
        )}
      </div>
