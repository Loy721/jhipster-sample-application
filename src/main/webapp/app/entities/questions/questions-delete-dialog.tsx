...
export const QuestionsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.questions.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.questions.delete.question" interpolate={{ id: questionsEntity.id }}>
