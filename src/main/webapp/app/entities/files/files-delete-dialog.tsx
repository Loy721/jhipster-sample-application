...
export const FilesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.files.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.files.delete.question" interpolate={{ id: filesEntity.id }}>
