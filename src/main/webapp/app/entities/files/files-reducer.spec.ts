...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './files.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILES actions', async () => {
      const expectedActions = [
        {
