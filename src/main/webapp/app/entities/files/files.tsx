  ...
  return (
    <div>
      <h2 id="files-heading" data-cy="FilesHeading">
        <Translate contentKey="jhipsterSampleApplicationApp.files.home.title">Files</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterSampleApplicationApp.files.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/files/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.files.home.createLabel">Create new Files</Translate>
          </Link>
        </div>
      </h2>
        ...
        {filesList && filesList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/files/${files.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/files/${files.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.files.home.notFound">No Files found</Translate>
            </div>
          )
        )}
      </div>
