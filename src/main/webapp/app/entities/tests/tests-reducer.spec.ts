...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTS actions', async () => {
      const expectedActions = [
        {
