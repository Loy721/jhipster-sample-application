...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYQUESTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYQUESTION actions', async () => {
      const expectedActions = [
        {
