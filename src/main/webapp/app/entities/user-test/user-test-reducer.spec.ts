...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERTEST actions', async () => {
      const expectedActions = [
        {
