    ...
    <Row>
      <Col md="8">
        <h2 data-cy="questionDetailsHeading">
          <Translate contentKey="jhipsterSampleApplicationApp.question.detail.title">Question</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplicationApp.question.myTest">My Test</Translate>
          </dt>
          <dd>{questionEntity.myTest ? questionEntity.myTest.id : ''}</dd>
        </dl>
