...
export const QuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.question.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.question.delete.question" interpolate={{ id: questionEntity.id }}>
