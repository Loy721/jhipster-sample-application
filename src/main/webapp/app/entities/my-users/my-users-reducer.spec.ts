...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './my-users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MYUSERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MYUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MYUSERS actions', async () => {
      const expectedActions = [
        {
