...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './publisher.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUBLISHER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PUBLISHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PUBLISHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PUBLISHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PUBLISHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PUBLISHER actions', async () => {
      const expectedActions = [
        {
