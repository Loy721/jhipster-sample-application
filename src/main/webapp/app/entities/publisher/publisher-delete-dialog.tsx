...
export const PublisherDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.publisher.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.publisher.delete.question" interpolate={{ id: publisherEntity.id }}>
