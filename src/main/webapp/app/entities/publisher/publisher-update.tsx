  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.publisher.home.createOrEditLabel" data-cy="PublisherCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.publisher.home.createOrEditLabel">Create or edit a Publisher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.publisher.name')}
                id="publisher-name"
                name="name"
                data-cy="name"
                type="text"
