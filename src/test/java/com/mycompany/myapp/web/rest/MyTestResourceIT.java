...
class MyTestResourceIT {
    ...
    void createMyTest() throws Exception {
        ...
        assertThat(testMyTest.getQuestions()).isEqualTo(DEFAULT_QUESTIONS);
    }
    ...
    void putExistingMyTest() throws Exception {
        ...
        assertThat(testMyTest.getQuestions()).isEqualTo(UPDATED_QUESTIONS);
    }
    ...
    void partialUpdateMyTestWithPatch() throws Exception {
        ...
        partialUpdatedMyTest.questions(UPDATED_QUESTIONS);
